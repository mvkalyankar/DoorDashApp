...
public class EditFoodActivity extends AppCompatActivity {
    ...
    private void loadFoodDetails() {
        ...
        reference.child(firebaseAuth.getUid()).child("Food").child(foodId)
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        //get data
                        String foodId = "" + snapshot.child("foodId").getValue();
                        String foodTitle = "" + snapshot.child("foodTitle").getValue();
                        ...
                        //set data to views
                        titleEt.setText(foodTitle);
                        descriptionEt.setText(foodDescription);
                        ...
                        try {
                            Picasso.get().load(foodIcon).placeholder(R.drawable.ic_add_shopping_white).into(foodIconIv);
                        } catch (Exception e) {
                            foodIconIv.setImageResource(R.drawable.ic_add_shopping_white);
                        }
                    }
    ...
    private String foodTitle, foodDescription, originalPrice, foodQuantity, discountPrice, discountNote;
    ...
    private void updateProduct() {
        ...
        if (image_uri == null) {
            ...
            //update to db
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
            reference.child(firebaseAuth.getUid()).child("Food").child(foodId).updateChildren(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            //update product detail
                            progressDialog.dismiss();
                            Toast.makeText(EditFoodActivity.this, "Food item updated", Toast.LENGTH_SHORT).show();
                        }
            ...
            String filePathAndName = "food_image/*" + "" + foodId;
