...
import com.example.doordashapp.FilterOrderShop;
...
public class AdapterOrderShop extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable {
    ...
    public HolderOrderShop onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // inflate layout
        View view = LayoutInflater.from(context).inflate(R.layout.row_order_owner, parent, false);
    ...
    public void onBindViewHolder(@NonNull AdapterOrderShop.HolderOrderShop holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // open order details
                Intent intent = new Intent(context, OrderDetailsOwnerActivity.class);
    ...
    private void loadUserInfo(ModelOrderShop modelOrderShop, HolderOrderShop holder) {
        // to load email of the user/buyer:  modelOrderShop.getOrderBy() contains uid of the user/buyer
    ...
    // view holder class for row_order_owner.xml
    class HolderOrderShop extends RecyclerView.ViewHolder {

        // UI views of row_order_owner.xml
